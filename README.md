...
- SQL pipeline: CREATE ACCOUNT, INSERT INTO ledger, SELECT with all filter variants, BALANCE, VERIFY_CHAIN, tamper detection, compatibility constants
- Rejection: UPDATE, DELETE, DROP TABLE, DROP DATABASE, read/write split enforcement
