...
pub enum PageError {
    ...
    #[error("Page checksum mismatch on page {page_id} (expected {expected:#010x}, got {actual:#010x})")]
    ChecksumMismatch { page_id: u64, expected: u32, actual: u32 },
    ...
    PageFull { page_id: u64, free_bytes: usize, needed: usize },
